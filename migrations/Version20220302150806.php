 ...
 */
final class Version20220302150806 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE companies ADD email VARCHAR(180) NOT NULL');
    }
