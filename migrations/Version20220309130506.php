 ...
 */
final class Version20220309130506 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contacts CHANGE zip_code zip_code VARCHAR(20) NOT NULL');
    }
